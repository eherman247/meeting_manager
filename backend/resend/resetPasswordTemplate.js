...
<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/collage/collage-image-2.png" />
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/shared/social-x-black.png" />
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/shared/social-in-black.png" />
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/shared/social-yt-black.png" />
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/shared/social-gh-black.png" />
  ...
  <body
    dir="ltr"
    lang="en"
    style="background-color:rgb(251,252,251);margin:0;padding:0">
    <!--$--><!--html--><!--head--><!--body-->
    <table
      border="0"
      width="100%"
                ...
                <tr style="width:100%">
                  <td
                    ...
                    <table
                      ...
                      cellspacing="0"
                      role="presentation"
                      style="border-radius:8px;box-shadow:0 0 rgb(0,0,0,0),0 0 rgb(0,0,0,0),0 0 rgb(0,0,0,0),0 0 rgb(0,0,0,0),0px 76px 21px 0px var(--tw-shadow-color, rgba(193,195,193,0)),0px 49px 19px 0px var(--tw-shadow-color, rgba(193,195,193,0.01)),0px 27px 16px 0px var(--tw-shadow-color, rgba(193,195,193,0.05)),0px 12px 12px 0px var(--tw-shadow-color, rgba(193,195,193,0.09)),0px 3px 7px 0px var(--tw-shadow-color, rgba(193,195,193,0.1))">
                      <tbody>
                        <tr>
                          <td>
                            <table
                                        ...
                                        <tr>
                                          <td>
                                            <img
                                              alt=""
                                              height="111"
                                              src="https://react-email-demo-6woqf4gn1-resend.vercel.app/static/collage/collage-image-2.png"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>
                                            ...
                                            <a
                                              href="${frontend}/reset-password?token=${resetPasswordToken}"
